...
Este documento contém exemplos práticos de como testar todas as operações de
NF-e implementadas no sistema.
...
**⚠️ IMPORTANTE:** Guarde o token retornado. Você precisará dele em todas as
requisições abaixo.
...
**⚠️ IMPORTANTE:** Guarde o `id` da empresa. Você precisará dele em todas as
operações abaixo.
...
- Chave de acesso deve ter 44 dígitos
- Para tipo "210240" (Operação não Realizada), justificativa é obrigatória
...
O sistema verifica automaticamente o status da SEFAZ antes de enviar a NF-e. Se
a SEFAZ estiver offline, a NF-e é automaticamente enfileirada para reenvio.
...
**Solução:** Certifique-se de que a empresa fiscal tem um certificado digital
válido cadastrado.
