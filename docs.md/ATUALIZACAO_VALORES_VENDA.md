...
**Botão para atualizar valores de venda de todos os materiais** baseado na configuração de markup atual (ex: 1,55x = 55% de lucro).

## 🎯 **Problema Resolvido**
- ❌ **Atualização manual**: Ter que entrar material por material para ajustar preços
...
- ✅ **Localização**: Página de Materiais → Dropdown "Ações" → "Atualizar Valores de Venda"
