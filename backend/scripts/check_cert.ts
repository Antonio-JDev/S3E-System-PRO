...
async function main(){
  ...
  const pfxPath = empresa.certificadoPath && empresa.certificadoPath.startsWith('/') ? empresa.certificadoPath : (empresa.certificadoPath ? path.resolve('/app', empresa.certificadoPath) : null);
  ...
  const senha = (empresa.certificadoSenha) ? (require('../src/utils/crypto.util').CryptoUtil.decrypt(empresa.certificadoSenha)) : '';
