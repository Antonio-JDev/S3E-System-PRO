 ...
 *
 * IMPORTANTE: estes helpers são apenas para exibição. Toda persistência e
 * cálculo continuam em centesimal/minutos, evitando o erro clássico de somar
 * floats no formato HH:mm (ex.: 1.37 + 1.37 ≠ 2.74).
 */
